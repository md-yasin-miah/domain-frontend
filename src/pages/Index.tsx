          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="animate-fade-in">
              ...
              <div className="text-muted-foreground font-roboto">
                {t("stats_section.verified_assets")}
              </div>
            </div>
            <div className="animate-fade-in">
              <div className="text-4xl font-roboto font-black text-primary mb-2">
              ...
              <div className="text-muted-foreground font-roboto">
                {t("stats_section.in_transactions")}
              </div>
            </div>
            <div className="animate-fade-in">
              <div className="text-4xl font-roboto font-black text-primary mb-2">
              ...
              <div className="text-muted-foreground font-roboto">
                {t("stats_section.registered_users")}
              </div>
            </div>
            <div className="animate-fade-in">
              <div className="text-4xl font-roboto font-black text-primary mb-2">
