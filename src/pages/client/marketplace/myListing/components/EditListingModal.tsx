...
const EditListingModal: React.FC<EditListingModalProps> = ({
  ...
  const { data: typesData } = useGetMarketplaceListingTypesQuery(undefined, {
    skip: !open,
  });
  const listingTypes = Array.isArray(typesData)
    ? typesData
    : (typesData as MarketplaceListingType[] ?? []);
  ...
  const selectedListingType =
    listingTypes.find((t) => t.id === formData.listing_type_id) ??
    listing?.listing_type;
  const typeSlug = (
    selectedListingType?.slug ??
  ...
  const isDomainType =
    typeSlug === "domain" ||
    typeSlug === "domains" ||
    typeSlug.includes("domain");
  const isWebsiteType =
    typeSlug === "website" ||
    typeSlug === "websites" ||
    typeSlug.includes("website");
  ...
  useEffect(() => {
    if (open && listing) {
      setFormData({
        ...
        listing_type_id:
          listing.listing_type_id ?? listing.listing_type?.id ?? 0,
        price: listing.price ?? "",
        ...
        image_urls_str: Array.isArray(listing.image_urls)
  ...
  const buildUpdatePayload = (): ListingUpdateRequest => {
    ...
    return {
      ...
      website_revenue_monthly: num(formData.website_revenue_monthly) as
        | number
        | undefined,
      website_profit_monthly: num(formData.website_profit_monthly) as
        | number
        | undefined,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title?.trim() || !formData.description?.trim()) {
      toast({
        ...
        description: t(
          "client.listings.edit.title_description_required",
    ...
    if (!formData.listing_type_id) {
      toast({
        title: t("client.listings.edit.validation_required", "Validation"),
        description: t(
          "client.listings.edit.listing_type_required",
    ...
    try {
      ...
      toast({
        ...
        description: t(
          "client.listings.edit.success_desc",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          <DialogTitle>
            {t("client.listings.edit.title", "Edit listing")}
          </DialogTitle>
          <DialogDescription>
            {t(
              "client.listings.edit.description",
        ...
        >
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-sm">
              {t("client.listings.edit.basic", "Basic information")}
            </h4>
            <div className="space-y-2">
              <Label htmlFor="edit-title">
                {t("client.listings.edit.title_label", "Title")} *
              </Label>
              <Input
                id="edit-title"
                ...
                placeholder={t(
                  "client.listings.edit.title_placeholder",
                  "Listing title",
                )}
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="edit-slug">
                {t("client.listings.edit.slug", "Slug")}
              </Label>
              <Input
                id="edit-slug"
                value={formData.slug}
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-short">
                {t(
                  "client.listings.edit.short_description",
                  "Short description",
                )}
              </Label>
              <Input
                ...
                placeholder={t(
                  "client.listings.edit.short_placeholder",
                  "Brief summary",
                )}
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="edit-desc">
                {t("client.listings.edit.description", "Description")} *
              </Label>
              <Textarea
                id="edit-desc"
                ...
                placeholder={t(
                  "client.listings.edit.description_placeholder",
                  "Full description",
                )}
                rows={4}
              />
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-sm">
              {t("client.listings.edit.pricing", "Type & pricing")}
            </h4>
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label>
                  {t("client.listings.edit.listing_type", "Listing type")} *
                </Label>
                <Select
                  value={
                ...
                >
                  <SelectTrigger>
                    <SelectValue
                      placeholder={t(
                        "client.listings.edit.select_type",
                        "Select type",
                      )}
                    />
                  </SelectTrigger>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="edit-negotiable" className="cursor-pointer">
                {t(
                  "client.listings.edit.price_negotiable",
                  "Price is negotiable",
                )}
              </Label>
            </div>
          ...
          {isDomainType && (
            <div className="space-y-4">
              <h4 className="font-semibold text-sm">
                {t("client.listings.edit.domain_info", "Domain information")}
              </h4>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label>
                    {t("client.listings.edit.domain_name", "Domain name")}
                  </Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label>
                    {t("client.listings.edit.domain_extension", "Extension")}
                  </Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label>
                    {t("client.listings.edit.domain_age", "Domain age (years)")}
                  </Label>
                  <Input
                    type="number"
                    min={0}
                ...
                <div className="space-y-2">
                  <Label>
                    {t(
                      "client.listings.edit.domain_authority",
                      "Domain authority",
                    )}
                  </Label>
                  <Input
                ...
                <div className="space-y-2 col-span-2">
                  <Label>
                    {t(
                      "client.listings.edit.domain_backlinks",
                      "Domain backlinks",
                    )}
                  </Label>
                  <Input
          ...
          {isWebsiteType && (
            <div className="space-y-4">
              <h4 className="font-semibold text-sm">
                {t("client.listings.edit.website_info", "Website information")}
              </h4>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2 col-span-2">
                  <Label>
                    {t("client.listings.edit.website_url", "Website URL")}
                  </Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label>
                    {t("client.listings.edit.traffic", "Monthly traffic")}
                  </Label>
                  <Input
                    type="number"
                    min={0}
                ...
                <div className="space-y-2">
                  <Label>
                    {t("client.listings.edit.revenue", "Monthly revenue")}
                  </Label>
                  <Input
                    type="number"
                    min={0}
                    ...
                    onChange={(e) =>
                      setFormData((p) => ({
                        ...p,
                        website_revenue_monthly: e.target.value,
                      }))
                    }
                    placeholder="0"
                  />
                ...
                <div className="space-y-2">
                  <Label>
                    {t("client.listings.edit.profit", "Monthly profit")}
                  </Label>
                  <Input
                    type="number"
                    min={0}
                    ...
                    onChange={(e) =>
                      setFormData((p) => ({
                        ...p,
                        website_profit_monthly: e.target.value,
                      }))
                    }
                    placeholder="0"
                  />
                ...
                <div className="space-y-2 col-span-2">
                  <Label>
                    {t("client.listings.edit.technology", "Website technology")}
                  </Label>
                  <Input
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-sm">
              {t("client.listings.edit.media_seo", "Images & SEO")}
            </h4>
            <div className="space-y-2">
              <Label>
                {t("client.listings.edit.primary_image", "Primary image URL")}
              </Label>
              <Input
            ...
            <div className="space-y-2">
              <Label>
                {t("client.listings.edit.image_urls", "Additional image URLs")}
              </Label>
              <Input
                value={formData.image_urls_str}
                onChange={(e) =>
                  setFormData((p) => ({ ...p, image_urls_str: e.target.value }))
                }
                placeholder={t(
                  "client.listings.edit.image_urls_placeholder",
            ...
            <div className="space-y-2">
              <Label>
                {t("client.listings.edit.meta_title", "Meta title")}
              </Label>
              <Input
            ...
            <div className="space-y-2">
              <Label>
                {t("client.listings.edit.meta_description", "Meta description")}
              </Label>
              <Textarea
