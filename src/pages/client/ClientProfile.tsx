        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold mb-2">
              {t("profile.client.profile_not_found")}
            </h3>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2 md:col-span-2">
            <Label htmlFor="address_line2">
              {t("profile.client.address_line2")}
            </Label>
            <Input
              id="address_line2"
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="social_facebook">
                {t("profile.client.social_facebook")}
              </Label>
              <Input
                id="social_facebook"
                type="url"
            ...
            <div className="space-y-2">
              <Label htmlFor="social_twitter">
                {t("profile.client.social_twitter")}
              </Label>
              <Input
                id="social_twitter"
                type="url"
            ...
            <div className="space-y-2">
              <Label htmlFor="social_linkedin">
                {t("profile.client.social_linkedin")}
              </Label>
              <Input
                id="social_linkedin"
                type="url"
            ...
            <div className="space-y-2">
              <Label htmlFor="social_instagram">
                {t("profile.client.social_instagram")}
              </Label>
              <Input
                id="social_instagram"
                type="url"
            ...
            <div className="space-y-2">
              <Label htmlFor="social_github">
                {t("profile.client.social_github")}
              </Label>
              <Input
                id="social_github"
                type="url"
            ...
            <div className="space-y-2">
              <Label htmlFor="social_youtube">
                {t("profile.client.social_youtube")}
              </Label>
              <Input
                id="social_youtube"
                type="url"
