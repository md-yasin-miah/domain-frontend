...
const SupportPage = () => {
  ...
  const { data: categoriesData, isLoading: isLoadingCategories } =
    useGetSupportCategoriesQuery({ is_active: true });
      ...
      <Tabs value={tab} onValueChange={setTab} className="w-full">
        <TabsList className="grid w-full grid-cols-4">
          <TabsTrigger value="tickets">
            ...
            {statusCounts.all > 0 && `(${statusCounts.all})`}
          </TabsTrigger>
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  {t("support.tickets.no_tickets_title")}
                </h3>
                ...
                <>
                  ...
                  {filteredTickets.length === 0 && !isLoadingTickets && (
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-xl font-semibold mb-2">
                        {searchTerm
                          ? t("support.empty.search")
                          : t("support.empty.title")}
                      </h3>
                      <p className="text-muted-foreground mb-4">
                        {searchTerm
                          ? t("support.empty.search_description")
                ...
                >
                  {!user && (
                    <div className="bg-muted p-4 rounded-lg mb-4">
                      <p className="text-sm">
                        <strong>{t("support.form.tip")}</strong>{" "}
                        {t("support.form.tip_text")}
                      </p>
                    </div>
                  )}
                  <div className="grid md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>
                            {t("support.create.title_label")} *
                          </FormLabel>
                          <FormControl>
                            <Input
                              placeholder={t(
                                "support.create.title_placeholder"
                              )}
                              {...field}
                            />
                          </FormControl>
            ...
            <CardContent>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder={t(
                              "support.contact.message_placeholder"
                            )}
                            rows={6}
                            {...field}
                          />
              ...
              <div className="pt-6 border-t">
                <h4 className="font-semibold mb-4">
                  {t("support.contact.other_channels")}
                </h4>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {t("support.contact.hours_value")}
                    </p>
                  </div>
                  <div>
                    <p className="text-muted-foreground mb-1">
                      {t("support.contact.live_chat")}
                    </p>
                    <p className="font-medium">
                      {t("support.contact.live_chat_value")}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardHeader>
                ...
                <CardTitle>
                  {t("support.knowledge.troubleshooting.title")}
                </CardTitle>
                <CardDescription>
