...
import { Search, Filter, Globe, Smartphone, Package, TrendingUp, Code, Database, Play, Gem, ShoppingCart, ArrowRight, CheckCircle, Shield, Users, Award } from "lucide-react"
...
const Marketplace = () => {
  ...
  const categories = [
    { id: "dominios", name: t('categories.domains'), icon: Globe, count: 247, path: "/marketplace/dominios" },
    { id: "sitios", name: t('categories.websites'), icon: Globe, count: 89, path: "/marketplace/sitios" },
    { id: "apps", name: t('categories.mobile_apps'), icon: Smartphone, count: 34, path: "/marketplace/apps" },
    { id: "fba", name: t('categories.fba_stores'), icon: Package, count: 12, path: "/marketplace/fba" },
    { id: "ecommerce", name: t('categories.ecommerce'), icon: ShoppingCart, count: 56, path: "/categories/ecommerce" },
    { id: "saas", name: t('categories.software_saas'), icon: Code, count: 23, path: "/categories/software-saas" },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Tabs defaultValue="featured" className="w-full">
            ...
            <TabsContent value="featured" className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {featuredListings.filter(listing => listing.featured).map((listing) => (
                  <Card key={listing.id} className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-2 hover:border-primary/20">
                    ...
                    <CardContent className="pt-0">
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-muted-foreground">Tráfico/Métricas:</span>
                          <span className="text-sm font-medium">{listing.traffic}</span>
                        </div>
            ...
            <TabsContent value="newest">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {featuredListings.slice().reverse().map((listing) => (
                  <Card key={listing.id} className="group hover:shadow-xl transition-all duration-300">
                    <CardHeader>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <Button asChild className="w-full">
                          <Link to={`/marketplace/listing/${listing.id}`}>Ver Detalles</Link>
                        </Button>
                      </div>
                    </CardContent>
                  </Card>
            ...
            <TabsContent value="trending">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {featuredListings.filter(listing => listing.type === "Software" || listing.type === "App").map((listing) => (
                  <Card key={listing.id} className="group hover:shadow-xl transition-all duration-300">
                    <CardHeader>
                      <CardTitle className="group-hover:text-primary transition-colors">
                        {listing.title}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Proceso simple, seguro y transparente para comprar y vender activos digitales con total confianza
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <Button size="lg" className="bg-gradient-to-r from-primary to-secondary hover:shadow-xl px-8 py-4">
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-primary/10 via-background to-secondary/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Únete a miles de inversores que ya están construyendo su portafolio de activos digitales
          </p>
