              ...
              {menuItems.map((item) => {
                    ...
                    <DropdownMenu key={item.title}>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="ghost"
                          size="sm"
                          className={`flex items-center space-x-2 px-4 py-2 text-sm font-medium transition-all border duration-200 ${
                            isActive
                          ...
                          {item.subItems?.map((subItem) => {
                            ...
                            return (
                              <DropdownMenuItem key={subItem.title} asChild>
                                <Link
                                  to={subItem.url}
                                  className={`flex items-start space-x-3 p-4 rounded-lg transition-all group ${
                                    isSubItemActive
                                ...
                                >
                                  ...
                                  >
                                    <subItem.icon
                                      className={`w-4 h-4 ${isSubItemActive ? "text-primary" : "text-primary"}`}
                                    />
                                  </div>
                ...
                return (
                  <NavLink
                    ...
                    to={item.url}
                    className={({ isActive }) =>
                      `flex items-center space-x-2 px-4 border py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                        isActive
                          ? "bg-primary/10 text-primary border-primary/20"
                          : "text-muted-foreground hover:text-foreground hover:bg-muted/60 border-transparent"
                      }`
                    ...
                    {userServices?.map((item) => {
                      ...
                      return (
                        <DropdownMenuItem key={item.title} asChild>
                          <Link
                            to={item.url}
                            className={`group flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors duration-300 cursor-pointer ${
                              isActive
                          ...
                          >
                            <item.icon
                              className={`w-4 h-4 group-hover:text-primary group-hover:scale-110 transition-all duration-300 ${
                                isActive
                                  ? "text-primary"
                  ...
                  return (
                    <div key={item.title} className="space-y-3">
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-2 py-2 text-xs font-semibold uppercase tracking-wider rounded-lg transition-all ${
                          isActive
                          ...
                          {item.subItems.map((subItem) => {
                            ...
                            return (
                              <Link
                                key={subItem.title}
                                to={subItem.url}
                                className={`flex ${isGridLayout ? "flex-col items-center space-y-2 text-center" : "items-center space-x-3"} p-4 rounded-xl transition-all ${
                                  isSubItemActive
                              ...
                              >
                                <div
                                  className={`p-2 rounded-lg ${isSubItemActive ? "bg-primary/20" : "bg-primary/10"} ${isGridLayout ? "" : "shrink-0"}`}
                                >
                                  <subItem.icon
                                    className={`w-4 h-4 ${isSubItemActive ? "text-primary" : "text-primary"}`}
                                  />
                                ...
                                <div
                                  className={isGridLayout ? "mt-1" : "flex-1"}
                                >
                                  <span
                                    className={`${isGridLayout ? "text-xs" : "text-sm"} font-medium ${
